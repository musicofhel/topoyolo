...
## B2 batch-010: sheaf neural networks (2026-08-25)

- **Hansen & Gebhart (2020)** — "Sheaf Neural Networks." arXiv: 2012.06333. Cellular-sheaf Laplacian as a GCN generalization: non-constant, asymmetric, dimension-varying relations via learned restriction maps — diffusion on the cochain complex with trainable coboundary data. Machines: chain complex (core), matching (per-edge correspondence), stability (empirical). Full annotation: `annotations/2012.06333.md` (B2 pass 52). **See also**: `by-structure/boundary_operators.md`.

- **Seely (2025)** — "Sheaf Cohomology of Linear Predictive Coding Networks." arXiv: 2511.11092. Predictive coding as cellular sheaf; cohomology = irreducible inference error; Hodge decomposition diagnoses learning stalls from recurrent feedback contradictions. The chain-complex ↔ neuroscience bridge. Machines: chain complex, null hypothesis (irreducible-error reading), stability, parameterized homology (weak). Full annotation: `annotations/2511.11092.md` (B2 pass 52). Abstract-only provenance — depth-limited. **See also**: `by-domain/neuroscience.md`, `by-structure/boundary_operators.md`.
- **Hu (2025)** — "Cellular Sheaves on Higher-Dimensional Structures." arXiv: 2505.23993. Non-trivial cellular sheaves above dimension 1: geometric constructions whose 0th sheaf Laplacian recovers anisotropic-network-model Hessians (higher sheaf Laplacians = multi-way interactions) alongside an algebraic ringed-space/sheaves-of-ideals framework — the graded chain complex gets sheaf-valued coefficients beyond graphs. Machines: chain complex (graded extension), stability (ANM elasticity reading). Full annotation: `annotations/2505.23993.md` (B2 pass 53). Abstract-only provenance — depth-limited. **See also**: `by-structure/boundary_operators.md`.
- **Dönmez, Mosig, Fritsche & Koch (2026)** — "Oversmoothing as Representation Degeneracy in Neural Sheaf Diffusion." arXiv: 2605.11178. Sheaf diffusion as incidence-quiver representation: oversmoothing = degeneration of learned restriction maps toward low-complexity summands, with the harmonic space (global sections) splitting along direct-sum decompositions; GIT moment-map regularizers and a stability-wall obstruction at equal stalk dimensions. First corpus entry importing GIT stability into the machine. Machines: chain complex, stability (GIT/moment-map incarnation), null hypothesis (equal-stalk vacuity). Full annotation: `annotations/2605.11178.md` (B2 pass 53). Abstract-only provenance — depth-limited. **See also**: `by-structure/boundary_operators.md`.

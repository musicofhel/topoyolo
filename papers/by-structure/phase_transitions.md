...
*Role map recorded in `glossary/ANTISYNONYMS.md` ("Power-law avalanche scaling ≠ evidence of self-organized criticality") — the corpus's first structured-disagreement entry; soc group continues with 1807.07213 (coexistence) + 1209.3271 (subsampling artifact) next pass.*

...
(claimed 219 papers vs 65 parsed headers — resolves as A3 slice 4 migrates
inbox.md Waves 4+ / at A4; author-year crossref debt ZERO — all annotations
id-matched incl. slug fallback `baudot-2015`)

## Task status
- A1 structure lint tool — **done 2026-08-24 (e6d03df)**
- A2 cross-ref/link debt paydown — **done 2026-08-24 (6f10501+b673c24)**
- A3 per-paper annotation files — **in_progress**: slices 1–3 done (1c96d87,
  5771173, 4b6db24): entire inbox-archive.md decomposed — Waves 1–2 + Wave 4b +
  Wave 3 triage + Phase 2 → `papers/annotations/` (31 verbatim files),
  Core ATT stubs (Adams/Gardner/Sugihara/Tsuda) repointed to per-paper files,
  archive now holds zero full annotations, lint green. Remaining: inbox.md
  Waves 4+ (34 headers).

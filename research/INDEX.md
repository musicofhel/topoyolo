...
- `2026-08-25-0915.md` — Pass 54: **batch-010 CLOSED 9/9** (07: 2502.03802
  ...
  2110.12288 Glad-Woolf path-signature signed-area + anytime-valid confidence
  sequences) + B3 sub-slice 7: CHAIN_COMPLEX.md sheaf-as-chain-complex-with-
  structure-maps synthesis. Counts to derived 170, deep cells 32.
...
- `2026-08-25-0902.md` — Pass 52: B2 batch-010 3/9 ANNOTATED (01:
  ...
  cohomology = irreducible inference error, chain-complex↔neuro bridge;
  06: 1601.00716 Cobey-Baskerville CCM limits, Timmer-class critique filed
  with null-surrogate lineage). Counts to derived 164, deep cells 32.
- `2026-08-25-0856.md` — Pass 51: **batch-009 CLOSED 10/10** — candidate-10
  ANNOTATED as 1906.05212 AS A PAIR with 1410.3831; B3 pairing flag discharged;
  antisynonyms "Exact RG↔DL mapping ≠ correlator-level identity" and "Abrupt
  jump ≠ phase transition" filed.
- `2026-08-25-0851.md` — Pass 50: B2 batch-009 rg-dl 4/5 ANNOTATED
  (2405.17538, 2504.12700, 2506.04016 inverse-RG). Counts to derived 160.
- `2026-08-25-0843.md` — Pass 49: batch-009 pid-theory CLOSED 5/5 + rg-dl
  opened (1410.3831 Mehta-Schwab).
- `2026-08-25-0837.md` — Pass 48: batch-009 pid-theory 3/5 (1004.2515
  Williams-Beer fresh file; 2306.00734; 1910.05979).
- `2026-08-25-0831.md` / `0827.md` — Passes 46–47: batch-008 kuramoto
  completed + B3 sub-slice 5.
- `2026-08-25-0750.md` / `0740.md` / `0735.md` — Passes 37–45: batch-007
  CLOSED 12/12, batch-008 reservoir-gs CLOSED 6/6, Phase A complete.
- Earlier (`2026-08-24-*`): batches 001–006, B1 ingestion contract.

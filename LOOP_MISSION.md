...
- **B2 [in_progress: pass 42 — batch-007 null-surrogate slice done 3/3 (07 Timmer nlin/0009032 — surrogate-null epistemics anchor, Null+Stability; 08 Timmer chao-dyn/9807039 — power vs non-stationarity; 09 Palus comp-gas/9507004 — multivariate redundancy nulls, joint-vs-marginal inside the null machinery). Same pass: Theiler wrong-pointer repair in phase_transitions.md (Tsuda catch-all → own file); README/docs count drift (stale at 131!) patched to derived truth. Counts at derived 137, deep cells 28. Next: null-surrogate candidates 10–12 to close batch-007. History: pass 41 closed batch-007 qec-mwpm group 6/6 (01 Higgott–Gidney sparse blossom 2303.15933; 02 Pattison et al. soft info 2107.13589; 03 Higgott et al. belief-matching 2203.04948 → boundary_operators; 04 Baireuther et al. RNN decoder 1705.07855 — joint-vs-marginal gain over marginal matching; 05 Hack et al. BP-on-decoding-graph 2603.05381 — carrier-graph fix for Tanner-BP's threshold failure, joins ldpc-bp lineage; 06 Fowler et al. 1202.5602 — O(n²) average-case complexity anchor of exact MWPM). See history below for batches 001–006.]]**** History: batch-001 21/21, batch-002 18/40 (22 HELD-by-orchestrator),

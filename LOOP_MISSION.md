...
- **B2 [in_progress→idle: pass 58 — batch-011 CLOSED 8/9 + 1 triage-reject: soc 08 ANNOTATED as 1807.07213 Moosavi-Montakhab-Valizadeh (oscillation-criticality coexistence via oscillatorily-driven Zhang model; optimal amplification AT the critical point — criticality-as-resonance; mechanism/reconciliation side of the structured disagreement, positive-control complement to the null lineage), soc 09 ANNOTATED as 1209.3271 Girardi-Schappo-Kinouchi-Tragtenberg (synaptic noise alone drives critical avalanches — noise-induced rather than self-organized; explicit subsampling analysis = simulation cousin of the empirical measurement-channel critique), fep 04 2207.06415 REJECTED (triage: DL implementation survey/practitioner guide, no abstract-machine instantiation). Filing debt FIXED: 2001.06408 backfilled into by-domain/statistical_physics.md (pass-56 omission). Counts to derived 178, deep cells 32; lint --check 0 errors. IDLE until batch-012 lands in papers/queue/ (orchestrator foraging); next-pass option: B3 GIT-antisynonym hook ("GIT semistability ≠ persistence stability"). Prior: pass 57 — batch-011 6/9: multi-party null representation SETTLED as a structured-disagreement entry in glossary/ANTISYNONYMS.md ('power-law avalanche scaling ≠ evidence of SOC' — role map claim/methodological-null/empirical-null; corpus position = role map + the regression-shape-vs-tested-distribution distinction; future N-party disagreements annotate by role). soc 05-07 ANNOTATED as that trio: 2102.09124 Plenz claim (branching≈1 homeostasis, E/I+dopamine control parameters), 0910.0805 Touboul-Destexhe methodological null (analytic spurious-power-law proof + known-SOC positive control), 1203.0738 Dehghani empirical null (exponential scaling across cat/monkey/human wake+sleep, bi-exponential wins). Counts to derived 176, deep cells 32. Remaining batch-011: soc 08 (1807.07213 oscillation-criticality coexistence), 09 (1209.3271 subsampling artifact), fep 04 (2207.06415 DL survey triage) — closes the batch next pass. Prior: pass 56 — batch-011 opened 3/9: fep 01+02 ANNOTATED AS A PAIR (1906.10184 Friston FEP monograph claim + 2001.06408 Biehl-Pollock-Kanai counterexample refutation of the free energy lemma; ANTISYNONYMS "Markov-blanket formalism ≠ established lemma" — first derivation-targeted null, witness = counterexample system not surrogate data), fep 03 ANNOTATED as 2008.03238 Ramstead et al. dual-aspect information geometry (post-critique constructive turn). Counts to derived 173, deep cells 32. Remaining batch-011: fep 04 (2207.06415 DL survey — triage candidate, likely reject); soc 05–09 (Plenz/Touboul-Destexhe/Dehghani THREE-WAY structured disagreement — decide multi-party null representation before annotating). Prior: pass 54 — batch-010 CLOSED 9/9: ccm 07 ANNOTATED as 2502.03802 Zhang et al. MXMap/multiPCM (Partial Cross Mapping lifted into multivariate delay embeddings; direct-vs-indirect = conditioned-vs-marginal mapping quality; two-phase graph workflow with per-edge mediation-null pruning), 08 ANNOTATED as 1909.00731 Barraquand et al. GC-vs-CCM empirical null (no nonlinearity-to-method correspondence across ecological networks — wrong-alternative study of the method-selection heuristic itself, conciliatory verdict for linear MAR(p)), 09 ANNOTATED as 2110.12288 Glad-Woolf path-signature signed-area causal discovery (antisymmetric degree-2 iterated integral; lag-axis matching + anytime-valid confidence sequences). Counts to derived 170, deep cells 32. IDLE until batch-011 lands. Prior: pass 53 — batch-010 6/9: candidate-03 ANNOTATED as 2505.23993 Hu higher-dim cellular sheaves (graded cochain data C⁰→C¹→C² beyond graphs; geometric branch recovers ANM Hessians as 0th sheaf Laplacian, higher Laplacians = multi-way interactions; parallel algebraic ringed-space/ideals branch), candidate-04 ANNOTATED as 2605.11178 Dönmez et al. oversmoothing-as-representation-degeneration (NSD = incidence-quiver representations; harmonic space splits along direct sums of boundary data; GIT moment-map regularizers — THIRD stability incarnation, orbit-closure semistability applied to the machine itself; equal-stalk stability-wall obstruction), candidate-05 ANNOTATED as 2410.23499 Butler et al. TSCI (learned vector fields on reconstructed manifolds, causality = synchronization degree between fields — drop-in CCM replacement, matching-by-fitting replaces neighbor retrieval). Counts to derived 167, deep cells 32. Remaining batch-010: ccm 07 (2502.03802 MXMap), 08 (1909.00731 GC-vs-CCM null), 09 (2110.12288 path signatures) — closes the batch next pass. Prior: pass 52 — batch-010 3/9: candidate-01 ANNOTATED as 2012.06333 Hansen-Gebhart Sheaf Neural Networks (founding SNN paper — sheaf Laplacian with learned restriction maps, dimension-varying stalks; chain complex as learnable architecture; FIRST corpus sheaf entries), candidate-02 ANNOTATED as 2511.11092 Seely PC-cohomology (coboundary = prediction error, cohomology = irreducible inference error, Hodge decomposition locates learning stalls; chain-complex↔neuroscience bridge), candidate-06 ANNOTATED as 1601.00716 Cobey-Baskerville CCM limits (Timmer-class wrong-alternative study of cross mapping; filed alongside null-surrogate lineage); counts to derived 164, deep cells 32. Remaining batch-010: sheaf 03 (2505.23993), 04 (2605.11178 GIT-stability → Stability row); ccm 05 (2410.23499 TSCI), 07 (2502.03802 MXMap), 08 (1909.00731 GC-vs-CCM null), 09 (2110.12288 path signatures). Prior: pass 51 — batch-009 CLOSED candidate-10 ANNOTATED as 1906.05212 de Mello Koch-de Mello Koch-Cheng hidden-visible-correlator diagnostics for RG-like coarse graining (RG-like patterns AND important differences), annotated AS A PAIR with 1410.3831 — B3 pairing flag discharged on both sides; claim-vs-refutation antisynonym filed in glossary/ANTISYNONYMS.md ("Exact RG↔DL mapping ≠ correlator-level identity"); counts to derived 161, deep cells 32. IDLE until batch-010 lands in papers/queue/ (orchestrator foraging). Residual Wave-era catch-all pointer debt (~100, ≤5/pass sanctioned). Prior: pass 50 — rg-dl 4/5 (07 2405.17538 BRG-NNFT Fisher-metric coarse graining; 08 2504.12700 two-phase fit→compress, MI progress measure; 09 2506.04016 inverse-RG minimal nets — first inverse-direction entry); derived 160, deep 32. Prior: pass 49 — pid-theory CLOSED 5/5 (04 2404.01470 Milzman I_ft + QEC crossref; 05 1303.3440 localizability axiom) + rg-dl opened 1/5 (06 1410.3831 Mehta-Schwab founding claim). Pass 48 — pid-theory 3/5 (1004.2515 Williams-Beer fresh file despite prose refs; 2306.00734 mereological unification; 1910.05979 cooperative-game second lattice). History: pass 47 — batch-008 CLOSED 11/11 (kuramoto 10-11: 2109.08918 ML-for-Kuramoto learned order parameters; 1305.1742 Kuramoto-in-Hamiltonian-systems sync-as-transverse-instability) + B3 sub-slice 5 (MATCHING.md Takens bridge pair). Pass 46 — kuramoto 3/5 (2407.02416 Buendía mesoscopic; 2505.10114 extreme-sync transitions null-hypothesis core; cond-mat/0606048 eight-regime taxonomy). Passes 44-45 — reservoir-gs group CLOSED 6/6 (GS=matching arc: Takens-as-GS bridge pair 2108.05024×2409.08768, conditional-Lyapunov margins, abstraction-as-attractor-continuum, quantum RC GS=ESP). Pass 43 — batch-007 CLOSED 12/12 (qec-mwpm 01-06: sparse blossom 2303.15933, soft info 2107.13589, belief-matching 2203.04948, RNN decoder 1705.07855, BP ldpc-bp fix 2603.05381, Fowler 1202.5602 complexity anchor; null-surrogate 10-12: 1101.6063 band-phase surrogates, 1211.1162 visibility-graph irreversibility, 1306.4064 network surrogates); same-commit count protocol adopted. See history below for batches 001–006.]]**** History: batch-001 21/21, batch-002 18/40 (22 HELD-by-orchestrator),
...
- **B3 [in_progress: sub-slices 1–9 done; sub-slice 9 = pass 59 (580fe1f): ANTISYNONYMS "GIT semistability ≠ persistence stability" (2605.11178 vs math/0604068 lineage — object/quantifier/failure-mode axes, S-equivalence, equal-stalk wall as incarnation-3-native null); role-map extension question stays Aaron-gated. Prior: sub-slice 8 = pass 55: atlas/STABILITY.md "Three Incarnations of the Stability Claim" — invariant-stability (TDA bottleneck/interleaving via 1205.3669+2201.06650), trajectory-correspondence stability (Lyapunov/GS via 2506.22335+2401.00885, Banach ρ<1), structure-stability (GIT moment-map semistability via 2605.11178), + composition note (structure→invariant→trajectory pipeline); sanctioned one-line cleanup landed same commit ('mathematics' → gen_stats KNOWN_QUALIFIERS, warning 2→1); lint --check 0 errors. Sub-slices 1–6 done — 6 = pass 51: ANTISYNONYMS "Exact RG↔DL mapping ≠ correlator-level identity" (1410.3831 claim vs 1906.05212 partial refutation, discharging the pairing flag) + ANTISYNONYMS "Abrupt order-parameter jump ≠ phase transition" (2505.10114 extreme-sync as null support for transition-vs-bifurcation inference). Sub-slice 7 = pass 54: atlas/CHAIN_COMPLEX.md "cellular sheaves — the chain complex with structure maps" (batch-010's four sheaf papers integrated: SNN learnable restriction maps, PC-cohomology irreducible-residue H¹, higher-dim graded cochains, GIT degeneration-as-instability). NEXT sub-slice queued by orchestrator: STABILITY.md tri-incarnation section (2605.11178 GIT moment-map semistability as third stability incarnation alongside TDA bottleneck/interleaving and dynamical Lyapunov/ESP). Sub-slice 5 = pass 47: atlas/MATCHING.md "Same theorem, two machines" — Takens via conjugacy 2108.05024 vs via pushforward 2409.08768, Lagrangian/Eulerian split with complementary Stability certificates; both annotations See-also repointed). Sub-slices 1–4 done passes 33–38 — 1: ANTISYNONYMS "Matching metric ≠ stability guarantee"; 2: thermodynamic-instantiation subsections on optimal_transport.md + composite_systems.md; 3 (pass 37): MATCHING.md "Two Cross-Machine Roles" (OT-as-proof-technology inbound to statphys via 1905.10031; PH→Matching bridge via Chambers–Meng 2507.01171) + cond-mat/9908104 ldpc-bp ancestor lineage note in statistical_physics.md; 4 (pass 38): optimal_transport.md "Monge–Kantorovich split inside this file" (coupling-side vs map-side corpus instances, non-atomic GM=GW as regime theorem). Open hooks remaining: possible ANTISYNONYMS note from 1910.05979 (positivity+identity is a lattice property); dynamical_systems.md atlas re-read post-batch-008.] Atlas synthesis touch-ups.** After ~15 new papers: re-read the
